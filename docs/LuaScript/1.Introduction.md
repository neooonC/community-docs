...
- Fill in your script [filename](/docs/tools-in-mtk/addressable-config/introduction) in the Script Name field (without .txt extension)
...
- Fill in your interaction script [filename](/docs/tools-in-mtk/addressable-config/introduction) in the Script Name field
...
- Fill in your flight control script [filename](/docs/tools-in-mtk/addressable-config/introduction) in the Script Name field
